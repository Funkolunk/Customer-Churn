...
row = [Gender, Age, Married, num_dependent, num_referrals,
        tenure_months, Offer, phone_service,
        avg_mnthly_longdist_charges, multiple_lines, internet_service,
        internet_type, online_security,
        online_backup, device_protect_plan, prem_tech_support,
        streaming_TV, streaming_movies, streaming_music, unlimited_data, avg_mnthly_GB_download, 
        Contract, paperless_billing, payment_method, monthly_charge,
        total_charges, total_refunds, total_extra_data_charges,
        total_long_dist_charges, total_revenue]
columns = ['Gender', 'Age', 'Married', 'num_dependent', 'num_referrals',
       'tenure_months', 'Offer', 'phone_service',
       'avg_mnthly_longdist_charges', 'multiple_lines', 'internet_service',
       'internet_type', 'online_security',
       'online_backup', 'device_protect_plan', 'prem_tech_support',
